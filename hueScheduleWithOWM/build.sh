...
docker build -f scheduler.Dockerfile -t ${REGISTRY}/scheduler:${VERSION} .
docker push ${REGISTRY}/scheduler:${VERSION}
echo "✓ Scheduler built and pushed"

# Build sunrise
echo "Building sunrise..."
docker build -f sunrise.Dockerfile -t ${REGISTRY}/sunrise:${VERSION} .
docker push ${REGISTRY}/sunrise:${VERSION}
echo "✓ Sunrise built and pushed"

# Build sunset
echo "Building sunset..."
docker build -f sunset.Dockerfile -t ${REGISTRY}/sunset:${VERSION} .
